...
{{--                        @endif--}}
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-neutral-500 hover:text-neutral-400 hover:bg-neutral-900 focus:outline-none focus:bg-neutral-900 focus:text-neutral-400 transition duration-150 ease-in-out">
